        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../admin/ajouter.php">Nouveau</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../admin/supprimer.php">Suppression</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../admin/modif.php">Modification</a>
                    </li>
                    <li class="nav-item">
                ...
                <div style="margin-right: 500px">
                    <h5 style="color: #545659; opacity: 0.5;">Vous êtes connecté à : <?= $_POST['email'] ?></h5>
                </div>
