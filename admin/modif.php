...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="../">TwinsFashions</a>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            <?php foreach ($leProduit as $produit) : ?>
                ...
                <form method="post">
                    <div class="mb-3">
                        <label for="id" class="form-label">L'id du produit</label>
                        <input type="name" class="form-control" name="id" value="<?= $produit->id ?>" readonly required>
